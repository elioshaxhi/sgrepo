...
public class Joomla15PasswordHash {
    ...
    /**
     * Takes the MD5 hash of a sequence of ASCII or LATIN1 characters, and
     * returns it as a 32-character lowercase hex string.
     *
     * Equivalent to MySQL's MD5() function and to perl's
     * Digest::MD5::md5_hex(), and to PHP's md5().
     *
     * Does no error-checking of the input, but only uses the low 8 bits from
