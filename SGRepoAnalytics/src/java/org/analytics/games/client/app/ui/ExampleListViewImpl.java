...
import org.analytics.games.client.images.ExampleImages;
...
import org.analytics.games.client.model.Category;
import org.analytics.games.client.model.Example;
import org.analytics.games.client.model.ExampleModel;
import org.analytics.games.client.model.NamedModel;
import org.analytics.games.client.model.NamedModel.NamedModelProperties;
...
public class ExampleListViewImpl implements ExampleListView {
  ...
  //private serverAsync rpcService;
...
//rpcService.getSGSAnalytics(
//				new AsyncCallback<Analytics>() {
//					public void onSuccess(Analytics result) {
//						AnalyticsStatic.analytics=result;
//					analytics=result;
//					}
//
