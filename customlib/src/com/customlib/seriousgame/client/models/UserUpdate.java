 ...
 * @author Nertil & Elion
 */
public class UserUpdate implements IsSerializable {
	 ...
	 * @param params
	 */
	public UserUpdate(int id, String name, String username, String email, String password, String usertype, int block, int sendEmail, int gid, String registerDate, String lastvisitDate, String activation, String params) {
		this.id = id;
		this.name = name;
