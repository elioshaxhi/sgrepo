 ...
 * @author NERTIL
 */
public class ScoreFieldSet extends FieldSet{
    private Slider score;
    private MyExtendedClasses.CostomTextArea motivation;

    public ScoreFieldSet(String fieldsetTitle, int scoreValue, String motivationValue) {
...
//        setExpanded(false);
        ...
        motivation = new MyExtendedClasses.CostomTextArea(Constants.Strings.analysis_motivation(), null);
    ...
    {
        return motivation.getValue();
    }
    public void setMotivation(String motivationValue)
    {
        motivation.setValue(motivationValue);
    }
}
