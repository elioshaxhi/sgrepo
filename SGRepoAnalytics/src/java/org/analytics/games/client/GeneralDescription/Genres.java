...
@Detail(name = "Genres Chart", icon = "piechart", category = "GeneralDescription")
public class Genres implements IsWidget, EntryPoint {
	...
	public Widget asWidget() {
		...
		Torta genres=new Torta("Genres Chart");
		genres.setMappa(acc, "genres");
		genres.setCoda(analytics.getGenresList(),"Genres Chart");
