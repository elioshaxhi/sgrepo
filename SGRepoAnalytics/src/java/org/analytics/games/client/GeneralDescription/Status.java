...
@Detail(name = "Status Chart", icon = "piechart", category = "GeneralDescription")
public class Status implements IsWidget, EntryPoint {
	...
	public Widget asWidget() {
		...
		Torta genres=new Torta("Status Chart");
		genres.setMappa(acc, "status");
		genres.setCoda(analytics.getStatusList(),"Status Chart");
