...
@Detail(name = "Availability Chart", icon = "piechart", category = "GeneralDescription")
public class Availability implements IsWidget, EntryPoint {
	...
	public Widget asWidget() {
		...
		Torta genres=new Torta("Availability Chart");
		genres.setMappa(acc, "availability");
		genres.setCoda(analytics.getAvailabilityList(),"Availability Chart");
