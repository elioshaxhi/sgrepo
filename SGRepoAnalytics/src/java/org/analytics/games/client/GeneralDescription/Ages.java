...
@Detail(name = "Ages Chart", icon = "piechart", category = "GeneralDescription")
public class Ages implements IsWidget, EntryPoint {
	...
	public Widget asWidget() {
		...
		Torta genres=new Torta("Ages Chart");
		genres.setMappa(acc, "genres");
		genres.setCoda(analytics.getAgesList(),"Ages Chart");
